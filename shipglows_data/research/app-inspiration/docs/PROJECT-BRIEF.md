...
- **Stack Analysis**: `shipglows_data/technical/app/` or `shipglows_data/technical/site/` depending on the target surface
- **Inspiration**: `shipglows_data/business/business.md` plus the relevant surface docs in `shipglows_data/technical/app/` or `shipglows_data/technical/site/`
