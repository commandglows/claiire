...
```
✓ Created shipglows_data/ corpus for governance and docs
✓ Created /assets folder - All images organized
✓ Moved documentation and references under shipglows_data/
...
2. **Create Product Brief** (`*create-product-brief`)
   - Or use the existing `shipglows_data/business/`, `shipglows_data/editorial/site/`, or `shipglows_data/technical/site/` docs
...
2. `shipglows_data/business/` - Complete shared business and product positioning
3. `shipglows_data/technical/site/` - Technical details

### For Using BMAD
1. `shipglows_data/technical/site/` - Getting started guide
...
- [x] Documentation organized in shipglows_data/
