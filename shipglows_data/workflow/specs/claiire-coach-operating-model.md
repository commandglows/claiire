...
depends_on:
  ...
  - artifact: "app/BRANDING.md"
    artifact_version: unknown
    required_status: unknown
  - artifact: "shipglows_data/workflow/explorations/2026-06-29-claiire-coach-evolution-personnelle.md"
...
- `shipglows_data/branding/branding.md` or a shared brand extension artifact
  - clarified coaching-language rules if the current shared branding file remains absent
- `shipglows_data/editorial/site/coaching-claims-and-copy-map.md`
  - site promises, disclaimers, page-level phrasing, and proof obligations
- `shipglows_data/product/app/coaching-flow-map.md`
...
- [ ] Task 1: Create the canonical coaching operating-model artifact.
  - File: `shipglows_data/product/shared/coach-operating-model.md`
  ...
  - Depends on: None.
  - Validate with: artifact exists with Shipglows metadata and references this spec.
...
- [ ] Task 2: Declare design-system and brand authority for coaching-visible surfaces.
  - File: `shipglows_data/technical/design-system-authority.md`
...
- [ ] Task 3: Build the cross-surface claim and copy map.
  - File: `shipglows_data/editorial/site/coaching-claims-and-copy-map.md`
...
- [ ] Task 4: Define the app coaching flow map.
  - File: `shipglows_data/product/app/coaching-flow-map.md`
...
- [ ] Task 6: Redefine gamification for coach-compatibility.
  - File: `shipglows_data/product/app/coaching-flow-map.md` and relevant product contract artifacts
...
- [ ] Task 7: Create a scenario-based prompt and behavior test matrix.
  - File: `shipglows_data/workflow/verification/claiire-coach-scenarios.md`
...
- [ ] Task 8: Route implementation into smaller chantiers if needed.
  - File: `shipglows_data/workflow/specs/`
...
| 2026-08-09 10:14:00 UTC | 007-sg-content | GPT-5 Codex | Archived the four-message positioning exchange exactly as requested with `verbatim 4` | implemented | Revise the draft positioning contract before readiness |
...
| 007-sg-content | done | Four-message verbatim positioning archive preserved under the governed repurpose-pack path. |
| 101-sf-ready | next | Revise the audience and violence-path contract, then review ambiguity, proof, and source-of-truth completeness before implementation. |
