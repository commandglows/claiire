...
- Le branding partage vit sous `shipglowz_data/branding/`.
- Le business partage vit sous `shipglowz_data/business/business.md`.
- Les tokens, themes, variables et composants runtime ne vivent pas ici. Ils doivent rester dans les surfaces techniques concernees, par exemple `shipglowz_data/technical/site/` ou `shipglowz_data/technical/app/`.
