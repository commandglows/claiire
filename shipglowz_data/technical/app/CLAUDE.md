...
- shared business/product: `shipglowz_data/business/business.md`
- shared branding: `shipglowz_data/branding/branding.md`
- app workflow history: `shipglowz_data/workflow/app/`
- inspiration archive: `shipglowz_data/research/app-inspiration/`
...
- safe vocabulary rules from `shipglowz_data/technical/app/guidelines.md` apply everywhere
