...
- **Stack Analysis**: `shipglowz_data/technical/app/` or `shipglowz_data/technical/site/` depending on the target surface
- **Inspiration**: `shipglowz_data/business/business.md` plus the relevant surface docs in `shipglowz_data/technical/app/` or `shipglowz_data/technical/site/`
