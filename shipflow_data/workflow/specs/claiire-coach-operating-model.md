...
linked_systems:
  ...
  - "shipflow_data/workflow/explorations/2026-06-29-claiire-coach-evolution-personnelle.md"
depends_on:
  ...
  - artifact: "app/BRANDING.md"
    artifact_version: unknown
    required_status: unknown
  - artifact: "shipflow_data/workflow/explorations/2026-06-29-claiire-coach-evolution-personnelle.md"
    artifact_version: "1.0.0"
    required_status: draft
  - artifact: "$SHIPFLOW_ROOT/skills/references/design-system-token-contract.md"
    artifact_version: "1.0.0"
...
- [ ] Task 1: Create the canonical coaching operating-model artifact.
  - File: `shipflow_data/product/shared/coach-operating-model.md`
  ...
  - Depends on: None.
  - Validate with: artifact exists with ShipFlow metadata and references this spec.
...
- [ ] Task 2: Declare design-system and brand authority for coaching-visible surfaces.
  - File: `shipflow_data/technical/design-system-authority.md`
...
- [ ] Task 3: Build the cross-surface claim and copy map.
  - File: `shipflow_data/editorial/site/coaching-claims-and-copy-map.md`
...
- [ ] Task 4: Define the app coaching flow map.
  - File: `shipflow_data/product/app/coaching-flow-map.md`
...
- [ ] Task 6: Redefine gamification for coach-compatibility.
  - File: `shipflow_data/product/app/coaching-flow-map.md` and relevant product contract artifacts
...
- [ ] Task 7: Create a scenario-based prompt and behavior test matrix.
  - File: `shipflow_data/workflow/verification/claiire-coach-scenarios.md`
