...
- Le branding partage vit sous `shipflow_data/branding/`.
- Le business partage vit sous `shipflow_data/business/business.md`.
- Les tokens, themes, variables et composants runtime ne vivent pas ici. Ils doivent rester dans les surfaces techniques concernees, par exemple `shipflow_data/technical/site/` ou `shipflow_data/technical/app/`.
