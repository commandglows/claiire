...
- Marque partagee : voir le bundle `shipflow_data/branding/` en commencant par `shipflow_data/branding/branding.md`
...
- branding partage : `shipflow_data/branding/` avec `branding.md`, `voice-and-tone.md`, `messaging-pillars.md`, `visual-identity.md`, `brand-rules.md`
- billing : `shipflow_data/business/billing-strategy.md`
- inspirations et concurrents : `shipflow_data/business/project-competitors-and-inspirations.md`
- inspiration archivee et classee : `shipflow_data/research/app-inspiration/`
