...
- qui appeler
- où aller
- quels documents garder accessibles
- quoi faire si ton téléphone ou tes recherches sont surveillés

Le reste vient ensuite.

## Les signaux de risque élevé

Certains éléments rendent une situation plus dangereuse et demandent une vigilance immédiate :

- la violence augmente en fréquence ou en intensité
- il y a eu strangulation, menace de mort ou menace de suicide
- il y a accès à des armes
...
Un plan de sécurité minimal doit déjà répondre à trois questions :

1. qui j'appelle si j'ai besoin d'aide maintenant ?
2. où sont mes documents et ce qu'il me faut pour partir vite ?
3. quel est l'endroit le plus sûr si la situation monte d'un coup ?

Ce module t'aide à rendre ces réponses plus concrètes.
...
- utiliser un appareil que l'autre personne ne contrôle pas
- vérifier les applications inconnues
...
- comment évaluer plus lucidement le niveau de risque
- ce qu'il faut préparer avant une crise
- comment construire un kit d'urgence simple
- pourquoi la sécurité numérique fait partie du plan
- comment t'appuyer sur un relais humain ou associatif

## Ce module est pour toi si...

- tu ne sais pas exactement quoi faire si la situation empire
- tu hésites entre rester, préparer, parler ou partir
...
### Est-ce qu'un plan de sécurité veut dire qu'il faut partir tout de suite ?

Non. Ça veut dire que tu n'es pas obligé(e) d'improviser si la situation devient plus dangereuse.
