...
- comment fonctionne la dissonance cognitive
- pourquoi les justifications viennent si vite
- la différence entre culpabilité et honte
- comment regarder l'impact sur l'autre sans te raconter d'histoires
- comment commencer un vrai travail de responsabilité

## Ce module est pour toi si...

- tu sens qu'il faut changer mais tu restes souvent dans "oui, mais"
- tu te reconnais dans des mécanismes de déni ou de minimisation
- tu regrettes après coup sans réussir à empêcher la répétition
- tu veux un cadre plus solide que la simple bonne intention

## Quelques repères de fond

Ce module s'appuie notamment sur :

- **Leon Festinger** pour la dissonance cognitive
...
- la version intégrale du module, plus nuancée et plus guidée
- l'exercice complet sur l'inventaire des explications
- la checklist pour repérer tes mécanismes de protection
- un protocole simple pour rester dans les faits sans fuir ni te détruire
- des repères pour passer vers le module 2 sans perdre l'élan

## Extrait du module complet

Dans la version complète, on va plus loin sur des points qui changent la qualité du travail :
...
### Est-ce que reconnaître un problème fait de moi quelqu'un de mauvais ?

Non. Ça fait de toi quelqu'un qui commence à voir.

### Est-ce que ce module parle aussi de violence psychologique ?

Oui. Le parcours auteurs ne se limite pas aux violences physiques.
...
- [Continuer avec le module 2](/formations/auteurs/2-cycle/)
