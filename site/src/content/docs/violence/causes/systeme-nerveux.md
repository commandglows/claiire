---
title: "Le système nerveux face à la violence"
description: "Comment ton système nerveux réagit, s'adapte et se dérègle face à la violence. Des réponses immédiates de survie aux impacts neurobiologiques du trauma chronique, comprendre ces mécanismes est la première étape pour retrouver un sentiment de sécurité."
---
...
[Comprendre en détail les 4 réactions de survie](/violence/mecanismes/reactions-survie-4f)
...
[Approfondir la mémoire traumatique](/violence/mecanismes/memoire-traumatique)
...
1. **Sécurité et connexion** (nerf vague ventral) : tu te sens en sécurité, tu peux te connecter aux autres, ton système digestif fonctionne, ta voix est mélodieuse. C'est l'état optimal pour la vie sociale, l'apprentissage, la créativité.

2. **Mobilisation** (système sympathique) : face à une menace, tu te prépares à combattre ou fuir. État d'urgence temporaire.

3. **Effondrement** (nerf vague dorsal) : quand la mobilisation ne suffit pas, le système bascule dans un shutdown profond — dissociation, engourdissement, figement, dépression.
...
:::tip[Ce que tu peux faire maintenant]
Même sans thérapie, certaines pratiques soutiennent la régulation du système nerveux au quotidien :
- La **respiration lente et profonde** (expiration plus longue que l'inspiration) active le nerf vague et la branche parasympathique
- Le **mouvement rythmique** (marche, danse, yoga) aide à compléter les cycles de stress bloqués dans le corps
- Le **contact social sécurisant** active directement le nerf vague ventral
- L'**ancrage sensoriel** (nommer 5 choses que tu vois, sentir tes pieds sur le sol) reconnecte le cortex à la réalité présente
:::
...
- [Le trauma et ses mécanismes](/violence/mecanismes/trauma)
- [Le fonctionnement complet du système nerveux](/systeme-nerveux)
- [Le stress et le cerveau](/systeme-nerveux/stress-impact)
- [Ressources d'aide psychologique](/violence/solutions/psychologique)
:::
