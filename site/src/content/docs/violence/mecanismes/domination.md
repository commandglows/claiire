---
title: "Les mécanismes de domination"
description: "Comprendre comment s'installent et se maintiennent les rapports de domination"
---

## Qu'est-ce que la domination ?

La domination est un système de relations où une personne ou un groupe exerce un pouvoir sur d'autres, limitant leur liberté et leur autonomie. Elle peut prendre diverses formes et s'exercer dans différents contextes. [La psychologie du pouvoir et de la domination](/psy) révèle comment ces dynamiques s'installent souvent à partir de blessures profondes — une peur de la vulnérabilité, un besoin de contrôle pour se sentir en sécurité, des traumatismes non résolus.
...
- [Protection juridique](/violence/solutions/juridique)
- [Associations d'aide](/violence/solutions/associations)
