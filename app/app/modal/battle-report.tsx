        ...
        <ScrollView contentContainerStyle={s.content}>
          ...
          <View style={s.grid}>
            {CRISIS_TYPES.map((type) => (
              ...
              >
                <AppIcon name={type.icon} color={crisisType === type.id ? AppDesignTokens.colors.dangerSoft : AppDesignTokens.colors.textMuted} size={AppDesignTokens.icons.sizeLg} />
        ...
        <ScrollView contentContainerStyle={s.content}>
          ...
          <View style={s.chipRow}>
            {EMOTIONS.map((e) => (
              ...
              >
                <AppIcon name={e.icon} color={emotion === e.id ? AppDesignTokens.colors.accentSoft : AppDesignTokens.colors.textMuted} size={AppDesignTokens.icons.sizeXs} />
...
const s = StyleSheet.create({
  ...
  backText: { color: AppDesignTokens.colors.accent, fontSize: AppDesignTokens.layout.v24, fontWeight: "600", padding: AppDesignTokens.layout.v4 },
  stepLabel: { color: AppDesignTokens.colors.textSubtle, fontSize: AppDesignTokens.layout.v13, fontWeight: "600" },
  content: { padding: AppDesignTokens.layout.v20, gap: AppDesignTokens.layout.v16, paddingBottom: AppDesignTokens.layout.v40 },
  centerContent: { flex: 1, padding: AppDesignTokens.layout.v20, alignItems: "center", justifyContent: "center", gap: AppDesignTokens.layout.v24 },
  title: { fontSize: AppDesignTokens.layout.v22, fontWeight: "bold", color: AppDesignTokens.colors.text },
  subtitle: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v14, marginTop: AppDesignTokens.layout.vMinus8 },

  // Type grid
  grid: { flexDirection: "row", flexWrap: "wrap", gap: AppDesignTokens.layout.v10 },
  typeCard: {
    width: "47%",
  ...
  typeIcon: { fontSize: AppDesignTokens.layout.v32 },
  typeLabel: { color: AppDesignTokens.colors.neutralBorder, fontSize: AppDesignTokens.layout.v13, fontWeight: "500", textAlign: "center" },
  ...
  intensityValue: { fontSize: AppDesignTokens.layout.v42, fontWeight: "900" },
  intensityMax: { color: AppDesignTokens.colors.textSubtle, fontSize: AppDesignTokens.layout.v14, marginTop: AppDesignTokens.layout.vMinus4 },
  intensityRow: { flexDirection: "row", gap: AppDesignTokens.layout.v6 },
  intensityDot: {
    width: AppDesignTokens.layout.v28,
    height: AppDesignTokens.layout.v28,
    borderRadius: AppDesignTokens.layout.v14,
    backgroundColor: AppDesignTokens.colors.surface,
    alignItems: "center",
    justifyContent: "center",
  ...
  intensityDotText: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v11, fontWeight: "600" },
  nextButton: {
  ...
  nextButtonText: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v16, fontWeight: "700" },
  skipDetails: { paddingVertical: AppDesignTokens.layout.v8 },
  skipDetailsText: { color: AppDesignTokens.colors.textSubtle, fontSize: AppDesignTokens.layout.v13 },

  // Details
  sectionLabel: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v13, fontWeight: "600", textTransform: "uppercase", letterSpacing: AppDesignTokens.layout.v0p5 },
  chipRow: { flexDirection: "row", flexWrap: "wrap", gap: AppDesignTokens.layout.v8 },
  chip: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: AppDesignTokens.colors.surface,
  ...
  chipIcon: { fontSize: AppDesignTokens.layout.v16 },
  chipLabel: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v13, fontWeight: "500" },
  ...
  logButtonText: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v16, fontWeight: "700" },
  ...
  resultEmoji: { fontSize: AppDesignTokens.layout.v48 },
  resultTitle: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v18, fontWeight: "700", textAlign: "center" },
  ...
  suggestionList: { width: "100%", gap: AppDesignTokens.layout.v8, marginTop: AppDesignTokens.layout.v4 },
  suggestionCard: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: AppDesignTokens.colors.surface,
  ...
  suggestionEmoji: { fontSize: AppDesignTokens.layout.v24 },
  suggestionInfo: { flex: 1, gap: AppDesignTokens.layout.v2 },
  suggestionTitle: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v14, fontWeight: "600" },
  suggestionDesc: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v12 },
  suggestionRate: { color: AppDesignTokens.colors.success, fontSize: AppDesignTokens.layout.v12, fontWeight: "700" },
  doneButton: {
    backgroundColor: AppDesignTokens.colors.surface,
    borderRadius: AppDesignTokens.layout.v12,
    paddingVertical: AppDesignTokens.layout.v14,
    paddingHorizontal: AppDesignTokens.layout.v32,
    marginTop: AppDesignTokens.layout.v12,
    borderWidth: 1,
    borderColor: AppDesignTokens.colors.border,
  },
  doneButtonText: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v14, fontWeight: "600" },
});
