...
const styles = StyleSheet.create({
  ...
  navButton: { padding: AppDesignTokens.layout.v8 },
  navText: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v24, fontWeight: "300" },
  monthTitle: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v18, fontWeight: "700" },
  weekRow: { flexDirection: "row" },
  weekCell: { flex: 1, alignItems: "center", paddingVertical: AppDesignTokens.layout.v8 },
  weekText: { color: AppDesignTokens.colors.textSubtle, fontSize: AppDesignTokens.layout.v12, fontWeight: "600" },
  ...
  dayCellToday: { backgroundColor: AppDesignTokens.colors.surface, borderRadius: AppDesignTokens.layout.v10 },
  dayText: { color: AppDesignTokens.colors.neutralBorder, fontSize: AppDesignTokens.layout.v14 },
  dayTextEmpty: { color: AppDesignTokens.colors.neutralDark },
  dot: { width: AppDesignTokens.layout.v5, height: AppDesignTokens.layout.v5, borderRadius: AppDesignTokens.layout.v3 },
  dotCombo: { backgroundColor: AppDesignTokens.colors.warning },
  legend: {
    flexDirection: "row",
    justifyContent: "center",
    gap: AppDesignTokens.layout.v20,
  },
  legendItem: { flexDirection: "row", alignItems: "center", gap: AppDesignTokens.layout.v6 },
  legendDot: { width: AppDesignTokens.layout.v8, height: AppDesignTokens.layout.v8, borderRadius: AppDesignTokens.layout.v4 },
  legendText: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v12 },
  detailCard: {
  ...
  detailTitle: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v16, fontWeight: "600" },
  detailRow: { flexDirection: "row", justifyContent: "space-between" },
  detailLabel: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v14 },
  detailValue: { color: AppDesignTokens.colors.text, fontSize: AppDesignTokens.layout.v14, fontWeight: "600" },
  detailTypes: { flexDirection: "row", gap: AppDesignTokens.layout.v6, flexWrap: "wrap" },
  typeBadge: {
    ...
    paddingVertical: AppDesignTokens.layout.v4,
  },
  typeBadgeText: { color: AppDesignTokens.colors.textMuted, fontSize: AppDesignTokens.layout.v12, textTransform: "capitalize" },
  detailEmpty: { color: AppDesignTokens.colors.textSubtle, fontSize: AppDesignTokens.layout.v14 },
  comboText: { color: AppDesignTokens.colors.warning, fontSize: AppDesignTokens.layout.v14, fontWeight: "600" },
});
