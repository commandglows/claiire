...
const styles = StyleSheet.create({
  overlay: {
    ...
    zIndex: AppDesignTokens.layout.v9999,
  },
  particle: {
    position: "absolute",
  ...
  card: {
    ...
    borderRadius: AppDesignTokens.layout.v24,
    padding: AppDesignTokens.layout.v32,
    alignItems: "center",
    gap: AppDesignTokens.layout.v12,
    marginHorizontal: AppDesignTokens.layout.v32,
    borderWidth: 2,
    ...
    shadowRadius: AppDesignTokens.layout.v30,
    elevation: AppDesignTokens.layout.v20,
  },
  emoji: { fontSize: AppDesignTokens.layout.v56 },
  title: {
    color: AppDesignTokens.colors.text,
    fontSize: AppDesignTokens.layout.v24,
    fontWeight: "900",
    textAlign: "center",
  },
  subtitle: {
    ...
    textAlign: "center",
    lineHeight: AppDesignTokens.layout.v22,
  },
  xpBonus: {
  ...
  companionText: {
    ...
    fontStyle: "italic",
    textAlign: "center",
    lineHeight: AppDesignTokens.layout.v18,
  },
  tapHint: {
